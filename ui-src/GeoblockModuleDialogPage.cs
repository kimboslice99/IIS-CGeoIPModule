...
namespace CGeoIPModule
{
    ...
    //public sealed class GeoblockModuleDialogPage : System.Windows.Forms.Form
    {
        ...
        private void Initialize()
        {
            ...
            System.IO.Stream removeImageStream = this.GetType().Assembly.GetManifestResourceStream("CGeoIPModule.resources.remove.png");
        ...
        void DisplayConfiguration()
        {
            ...
            for (int i = 0; i < comboBoxDenyAction.Items.Count; i++)
            {
                ...
                if (ci != null && ci.Value.ToString() == this.moduleConfiguration.Action)
                {
        ...
        protected override bool ApplyChanges()
        {
            if (this.isValidDatabase)
            {
                ...
                this.moduleConfiguration.CountryCodes.Clear();
                foreach (Country geoblockItem in selectedCountryCodesLB.CheckedItems)
                {
                    this.moduleConfiguration.CountryCodes.Add(geoblockItem);
                }
